...
from transforms_res import clean_transform
...
parser = argparse.ArgumentParser(description="Train resnet classifier model")
...
parser.add_argument("--save_model", help="save model", default = 'resnet.pt')
