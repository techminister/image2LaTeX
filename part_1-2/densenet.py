...
from transforms_densenet import clean_transform
...
parser = argparse.ArgumentParser(description="Train densenet classifier model")
...
parser.add_argument("--save_model", help="save model", default = 'densenet.pt')
...
def load_model(load, device):
	...
	model.classifier = nn.Linear(1024, 405)
